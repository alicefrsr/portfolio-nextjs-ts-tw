...
const projectsData = [
  ...
  },
  {
    ...
    desc: 'Enter the bill amount, number of people to split between and chose the tip, the app breaks down the total to pay per person. The focus was on learning Javascript, CSS Flexbox and Web accessibility. Frontend Mentor challenge, with CSS changes for accessibility.',
  ...
  },
  {
    ...
    desc: 'A Frontend Mentor challenge to test my CSS skills, implement dark/light mode using the Context API.',
  ...
  },
  {
    ...
    desc: 'Add, edit, delete your todos, saved to local storage. I improved it over time and used it to learn about the Context API, useReducer, how to implement customs hooks.',
  ...
  //   title: 'Bits & Bobs',
  //  summary: "Personal learning website I used to test new things with React.",
  //   desc: 'Personal learning website I used to test new things with React. I find it easier to learn new concepts in isolation. It started with 3 simple components and expanded as I went along.',
  //   tech: [
  //     'React',
  //     'Custom hooks',
  //     'useReducer',
  ...
  // },
  {
    ...
    title: 'Quiz app',
    summary:
      'React quiz built with React with 15 questions to test your knowledge !',
    desc: 'Features include a timer, a cancel and a restart button. A highscore is saved each time and updated if your latest score is higher than your previous highscore. Deployed on Netlify, then on Vercel just to test things out with a server and practice Express.',
  ...
  },
  {
    ...
    summary: "Order your pizzas from Chiara's pizza place.",
  ...
  },
  {
    ...
    desc: "Rest API (Create, Read, Delete) (Temp deploy on render.com's free plan, please be patient when loading the live demo!)",
    tech: [
      'React',
      'Responsive CSS',
      'Node.js',
  ...
  },
  {
    ...
    desc: "to further consolidate my Redux skills and all CRUD operations on a database. A good exposure to authentification with JWT, PayPal & Credit card integration. (Temp deploy on render.com's free plan, please be patient when loading the live demo!)",
    tech: [
      'React',
      'Bootstrap',
      'Redux',
